...
const FormInput = ({
  ...
  }, showDatePlaceholder && datePlaceholder ? /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, datePlaceholder) : date ? /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, datePickerWithTime ? (0, _dayjs.default)(date).format(dateTimeFormat ?? 'DD-MM-YYYY hh:mm:ss A') : (0, _dayjs.default)(date).format(dateFormat ?? 'DD-MM-YYYY')) : range && range.startDate && range.endDate ? /*#__PURE__*/_react.default.createElement(_reactNative.Text, null, `${(0, _dayjs.default)(range.startDate).format(dateFormat ?? 'DD-MM-YYYY')} - ${(0, _dayjs.default)(range.endDate).format(dateFormat ?? 'DD-MM-YYYY')}`) : dates && dates.length ? /*#__PURE__*/_react.default.createElement(_reactNative.View, {
    style: {
      flexDirection: 'row',
      flexWrap: 'wrap',
