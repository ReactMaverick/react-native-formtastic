...
const FormInput = ({
  ...
  return /*#__PURE__*/React.createElement(View, _extends({
    ...
    style: inputContainerStyle ?? [styles.defaultInputContainerStyle, !showCharacterLimit && {
  ...
  }, showDatePlaceholder && datePlaceholder ? /*#__PURE__*/React.createElement(Text, null, datePlaceholder) : date ? /*#__PURE__*/React.createElement(Text, null, datePickerWithTime ? dayjs(date).format(dateTimeFormat ?? 'DD-MM-YYYY hh:mm:ss A') : dayjs(date).format(dateFormat ?? 'DD-MM-YYYY')) : range && range.startDate && range.endDate ? /*#__PURE__*/React.createElement(Text, null, `${dayjs(range.startDate).format(dateFormat ?? 'DD-MM-YYYY')} - ${dayjs(range.endDate).format(dateFormat ?? 'DD-MM-YYYY')}`) : dates && dates.length ? /*#__PURE__*/React.createElement(View, {
    style: {
      flexDirection: 'row',
      flexWrap: 'wrap',
